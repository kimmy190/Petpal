            ...
            <div class="flex items-center md:order-2 items-center">
                ...
                <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow border" id="user-dropdown">
                    <div class="px-4 py-3 bg-gray-50">
                        <span class="block text-sm text-gray-900 font-medium">Toronto Community Centre</span>
                        <span class="block text-sm  text-gray-500 truncate">director1@tcc.ca</span>
                    </div>
                    <ul class="py-2" aria-labelledby="user-menu-button">
                        <li>
                            <!-- update shelter info -->
                            <a href="./shelter_update.html" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Settings</a>
                        </li>

                        <li>
                            <a href="./shelter_detail_shelter_view.html" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Dashboard</a>
                        </li>
                        <li>
                            <a href="./list_shelter_applications.html" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">My Applications</a>
                        </li>
                        <li>
