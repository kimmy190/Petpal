...
<!-- Navbar -->
    <nav class="border-gray-200">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="./main/main.html" class="flex items-center">
                <span class="self-center text-3xl font-bold whitespace-nowrap">Pet Pal</span>
            </a>
            <div class="flex md:order-2 items-center space-x-4">
                <a href="./signup&login/login.html" class="text-black text-base hover:underline font-medium">Login</a>
                ...
                <div id="dropdownNavbar"
                    ...
                    <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                        <li>
                            <a href="./signup&login/seeker_signup.html" class="block px-4 py-2 hover:bg-gray-100">Seeker</a>
                        </li>
                        <li>
                            <a href="./signup&login/first_shelter_signup.html"
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
                <ul
                    ...
                    <li>
                        <a href="./navbar/adopt_signup.html"
