...
const Header = () => {
  return (
    <div class="flex justify-center items-center p-3">
      <a
        href="shelter_detail_user_view.html"
      ...
      >
        <div class="rounded-full w-6 h-6 mr-2 mb-1">
          <img src="resources/shelter/shelter_logo.png"></img>
        </div>
        <h1 class="text-2xl font-bold text-gray-900 md:text-3xl lg:text-3xl">
          Toronto Adoption Center
        </h1>
